...
I am an experienced astrophysics researcher with expertise in Monte Carlo radiative transfer simulations for modeling the light curves and spectra of supernovae and kilonovae. Since becoming the lead developer of the ARTIS radiative transfer code in 2015, I have extended the capabilities of the code while speeding up existing functionality by 7.15x without loss of accuracy (measured Sim+2010 1.06Msun model on 960 cores of GSI Virgo cluster development branch on June 5, 2025 versus 2014 code version). I also created an associated python package of analysis and plotting tools (artistools) that is widely used within the artis collaboration.

I have also extended the code to operate in non-LTE conditions for nebular-phase, incorporating additional atomic data (e.g., for forbidden transitions, non-thermal collisions, and heavier elements), generalised the treatment of radioactive decay to include alpha and beta decays, and added time-dependent particle thermalisation physics for kilonovae.


%Some of my research software engineering highlights include writing high-performance parallel code to numerically solve systems of differential equations (to model chemical enrichment of stellar clusters and high-energy particle interactions), using matrix-based methods for solving large systems of linear equations (to determine atomic level populations), and applying Monte Carlo techniques to simulate radiative transfer (light-matter interactions) in three dimensions. I have contributed to open source software used in research, and advocated for software engineering best-practices in collaborative projects.\\

%I have a strong track record of obtaining scientific insights from computationally demanding theoretical work, having given many scientific talks at professional conferences and institutes, and published articles in peer-reviewed science journals. I have contributed as a co-investigator on successful research grants and HPC computing time proposals for international facilities.

%I enjoy teaching and have chosen to gain experience tutoring and lecturing undergraduate physics, and co-supervised PhD, Master's, and Google Summer of Code students on a variety of projects in astrophysics and software development.\\
%
...
I have expertise in:
\begin{itemize}
  \item Leading the development of numerically-intensive C++ code for 3D radiative transfer simulations
...
\item{Adapted the ARTIS radiative transfer code for application to kilonova modelling - relativistic corrections, particle thermalisation physics, and generalised radioactive decay treatment.}
\item{Published in scientific journals, including a first-author paper in Astrophysical Journal Letters.}
...
\item{Modernised and improved the ARTIS codebase, including training other researchers in best practices for collaborative software development and testing.}
...
\item{Created new open-source tools for analysis/visualisation of output data (artistools), conversion of external atomic data formats (artisatomic) that are in use by ~10 researchers.}
\item{Presented research at international conferences, contributed to peer-reviewed publication, grant applications, and computing-time proposals.}
...
\begin{itemize-noindent}
  ...
  \item Developed Fortran+OpenMP code to solve a system of differential equations to model chemical evolution in galaxies.
...
As of June 9, 2025, I am the author of 38 refereed articles with a total of 5,262 citations, and my h-index is 18 (NASA ADS). I have led and published 6 first-author peer-reviewed articles, which have 168 citations. My (non-peer-reviewed) AstroNote announcing the release of the ATLAS Forced Photometry Service has 123 citations.
