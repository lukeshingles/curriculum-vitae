...
%
% Within the School of Mathematics and Physics, I have volunteered as one of two Postdoctoral Representatives and am a member of the Athena SWAN committee for gender equality. In these roles, I have organised social events to build connections between people in different research clusters, organised career information days with invited speakers, and supported efforts to improve diversity in STEM careers.\\


I expertise in:
\begin{itemize}
  \item Leading the development of numerically-intensive software in C/C++ (> four years experience full-time employed)
